...
private:
	...
	void createInstance() {
		...
		instanceLayers.push_back("VK_LAYER_LUNARG_device_limits");
...
#ifdef VOXL_DEBUG
		// Add validation layers
		deviceLayers.push_back("VK_LAYER_LUNARG_parameter_validation");
		deviceLayers.push_back("VK_LAYER_LUNARG_object_tracker");
		deviceLayers.push_back("VK_LAYER_LUNARG_core_validation");
		deviceLayers.push_back("VK_LAYER_LUNARG_device_limits");
		deviceLayers.push_back("VK_LAYER_LUNARG_swapchain");
#endif
